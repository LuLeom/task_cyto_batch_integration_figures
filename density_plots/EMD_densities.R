...
EMDHor_makePlots <- function(method, 
  ...
  # Make plots for methods
  df <- rbind(anndata_to_df(i_adata = anndata::read_h5ad(paste0("intermediate_files/", dataset, "/method_out/", method, "_split1.h5ad")),
                            u_adata = unintegrated, split_id = "split1"),
              anndata_to_df(i_adata = anndata::read_h5ad(paste0("intermediate_files/", dataset, "/method_out/", method, "_split2.h5ad")),
